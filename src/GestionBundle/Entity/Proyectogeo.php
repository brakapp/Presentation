 ...
 * proyectogeo
 *
 * @ORM\Table(name="proyectogeo")
 * @ORM\Entity(repositoryClass="GestionBundle\Repository\ProyectogeoRepository")
 */
class Proyectogeo
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Proyectos", inversedBy="proyectogeo")
